...
type MsgSceneUDP struct {
	...
	MapDetails []uint32    `protobuf:"varint,3,rep,name=mapDetails" json:"mapDetails,omitempty"`
}
...
func (m *MsgSceneUDP) GetMapDetails() []uint32 {
	if m != nil {
		return m.MapDetails
	}
	return nil
...
func (m *MsgSceneUDP) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintWilds(dAtA, i, uint64(m.Frame))
	if len(m.MapDetails) > 0 {
		for _, num := range m.MapDetails {
			dAtA[i] = 0x18
			i++
			i = encodeVarintWilds(dAtA, i, uint64(num))
		}
	...
	for iNdEx < l {
		...
		case 3:
			if wireType == 0 {
				...
				m.MapDetails = append(m.MapDetails, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field MapDetails", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipWilds(dAtA[iNdEx:])
...
var fileDescriptorWilds = []byte{
	...
	,
}
