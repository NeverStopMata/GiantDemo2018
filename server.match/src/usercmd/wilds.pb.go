...
type CubeReDst struct {
	...
	RemainDistance int32  `protobuf:"varint,2,opt,name=remainDistance" json:"remainDistance"`
}
...
func (m *CubeReDst) GetRemainDistance() int32 {
	if m != nil {
...
type MsgLoginResult struct {
	...
	BlockInf     []bool           `protobuf:"varint,15,rep,name=blockInf" json:"blockInf,omitempty"`
}
...
func (m *MsgLoginResult) GetBlockInf() []bool {
	if m != nil {
		return m.BlockInf
	}
	return nil
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RemainDistance |= (int32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 15:
			if wireType == 0 {
				...
				m.BlockInf = append(m.BlockInf, bool(v != 0))
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field BlockInf", wireType)
			}
		default:
			iNdEx = preIndex
			skippy, err := skipWilds(dAtA[iNdEx:])
...
var fileDescriptorWilds = []byte{
	...
	,
}
