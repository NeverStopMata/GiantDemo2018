...
func (this *Tick) _enterNode(node IBaseNode) {
	...
	//glog.Info("_enterNode:", this.debug, " id:", node.GetID(), " ", node.GetTitle())
 ...
 * @protected
**/
func (this *Tick) _openNode(node IBaseNode) {
	// TODO: call debug here
}
 ...
 * @protected
**/
func (this *Tick) _tickNode(node IBaseNode) {
	// TODO: call debug here
	//glog.Info("_tickNode:", this.debug, " id:", node.GetID(), " ", node.GetTitle(), " count:", this._nodeCount)
}
 ...
 * @protected
**/
func (this *Tick) _closeNode(node IBaseNode) {
	// TODO: call debug here
	//glog.Info("_closeNode:", this.debug, " id:", node.GetID(), " ", node.GetTitle())
 ...
 * @protected
**/
func (this *Tick) _exitNode(node IBaseNode) {
	// TODO: call debug here
}
